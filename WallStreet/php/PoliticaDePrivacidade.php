...
<body>
    <div class="page">
        <div class="fundoPolitica__Main">
            <div class="FundoPolitica__Geral">
                <div class="Title_Politica">
                    <h1>Política de Privacidade</h1>
                </div>
                <div class="TXT_Politica">
                    <p>A sua privacidade é importante para nós. É política do Wallstreet respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="#">Wallstreet</a>, e outros sites que possuímos e operamos.</p>
                    ...
                    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Wallstreet oferece no site e com caráter enunciativo, mas não limitativo:</p>
                    <ul>
                        ...
                        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Wallstreet, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                    </ul>
                    ...
                    <p>Esta política é efetiva a partir de 14 August 2024 17:38</p>
                </div>
            </div>
        </div>
    </div>
